...
module.exports.settings = function () {
  ...
  if (config_file == "" && atom.project.relativizePath(linted_file)[0] != null) {
    var project_path = atom.project.relativizePath(linted_file)[0];
  ...
  if (atom.config.get("linter-gcc-portuguese.gccDebug")){
    if (config_file.length > 0) {
      console.log("linter-gcc-portuguese: Reading settings from: " + config_file);
    } else {
      console.log("linter-gcc-portuguese: Using configuration page settings");
    }
  }
  var commands_file = ""
  if (config_file != "") {
    ...
    if ("compileCommandsFile" in config_data) {
      ...
      commands_file = atom.config.get("linter-gcc-portuguese.compileCommandsFile");
    }
    return {
    ...
    return {
      execPath: atom.config.get("linter-gcc-portuguese.execPath"),
      gccIncludePaths: atom.config.get("linter-gcc-portuguese.gccIncludePaths"),
      gccISystemPaths: atom.config.get("linter-gcc-portuguese.gccISystemPaths"),
      gccSuppressWarnings: atom.config.get("linter-gcc-portuguese.gccSuppressWarnings"),
      gcc7orGreater: atom.config.get("linter-gcc-portuguese.gcc7orGreater"),
      gccDefaultCFlags: atom.config.get("linter-gcc-portuguese.gccDefaultCFlags"),
      gccDefaultCppFlags: atom.config.get("linter-gcc-portuguese.gccDefaultCppFlags"),
      gccErrorLimit: atom.config.get("linter-gcc-portuguese.gccErrorLimit"),
      gccErrorString: atom.config.get("linter-gcc-portuguese.gccErrorString"),
      gccWarningString: atom.config.get("linter-gcc-portuguese.gccWarningString"),
      gccNoteString: atom.config.get("linter-gcc-portuguese.gccNoteString"),
      compileCommandsFile: atom.config.get("linter-gcc-portuguese.compileCommandsFile"),
    };
  }
